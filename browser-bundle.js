...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStore = __webpack_require__(185);
	...
	var store = Redux.createStore(Redux.combineReducers(reducers), localStore.get(), window.devToolsExtension ? window.devToolsExtension() : undefined);
	...
	function history(state, action) {
	  switch (action.type) {
	    case 'ADD_HISTORY_ITEM':
	      ...
	      if (!action.data.error) return [Object.assign({}, action.data)].concat(state);else return state;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QDisplay = __webpack_require__(189);
	
	var _QDisplay2 = _interopRequireDefault(_QDisplay);
	
	var _QInputForm = __webpack_require__(190);
	
	var _QInputForm2 = _interopRequireDefault(_QInputForm);
	
	var _selectors = __webpack_require__(192);
	
	var Selectors = _interopRequireWildcard(_selectors);
	
	var _qUtil = __webpack_require__(191);
	
	var QUtil = _interopRequireWildcard(_qUtil);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onRemoveHistoryItem: function onRemoveHistoryItem(index) {
	      return dispatch(Actions.removeHistoryItem(index));
	    }
	  };
	};
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function handleChange(key, value) {
	      var inputChange = { key: key, value: value };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_QInputForm2.default, null),
	        _react2.default.createElement(
	          'table',
	          null,
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'tbody',
	            null,
	            this.props.current.error ? this.renderErrorRow(this.props.current.error) : this.renderQRow(this.props.current),
	    ...
	    key: 'renderQRow',
	    value: function renderQRow(obj) {
	      var i = arguments.length <= 1 || arguments[1] === undefined ? -1 : arguments[1];
	      var q = obj.q;
	      var fractBits = obj.fractBits;
	      var wholeBits = obj.wholeBits;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'td',
	          null,
	          'Q' + wholeBits + '.' + fractBits
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement(_QDisplay2.default, { q: q, format: 'hex' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement(_QDisplay2.default, { q: q, format: 'binary' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          QUtil.toFloat(q, fractBits, wholeBits)
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          i >= 0 ? _react2.default.createElement(
	            'button',
	            { type: 'submit', onClick: this.handleRemove.bind(this, i) },
	            'Delete'
	          ) : null
	        )
	      );
...
/***/ function(module, exports) {
	...
	var addHistoryItem = exports.addHistoryItem = function addHistoryItem(item) {
	  return { type: 'ADD_HISTORY_ITEM', data: item };
	};
	var removeHistoryItem = exports.removeHistoryItem = function removeHistoryItem(index) {
	  return { type: 'REMOVE_HISTORY_ITEM', data: index };
	};
	var updateInput = exports.updateInput = function updateInput(input) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QDisplay = function (_React$Component) {
	  _inherits(QDisplay, _React$Component);
	
	  function QDisplay() {
	    _classCallCheck(this, QDisplay);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QDisplay).apply(this, arguments));
	  }
	
	  _createClass(QDisplay, [{
	    key: 'render',
	    value: function render() {
	      if (this.props.format == 'binary') return _react2.default.createElement(
	        'code',
	        null,
	        QUtil.toBinaryString(this.props.q)
	      );else if (this.props.format == 'hex') return _react2.default.createElement(
	        'code',
	        null,
	        QUtil.toHexString(this.props.q)
	      );else return null;
	    }
	  }]);
	...
	QDisplay.propTypes = {
	  q: _react2.default.PropTypes.array.isRequired,
	  format: _react2.default.PropTypes.oneOf(['binary', 'hex'])
	};
	
	exports.default = QDisplay;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qUtil2 = _interopRequireDefault(_qUtil);
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return Object.assign({ current: Selectors.getCurrentQ(state) }, state.input);
	};
	
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onUpdateInput: function onUpdateInput(input) {
	      return dispatch(Actions.updateInput(input));
	    },
	    onAddHistoryItem: function onAddHistoryItem(item) {
	      return dispatch(Actions.addHistoryItem(item));
	    }
	  };
	};
	
	var QInputForm = function (_React$Component) {
	  _inherits(QInputForm, _React$Component);
	
	  function QInputForm() {
	    _classCallCheck(this, QInputForm);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QInputForm).apply(this, arguments));
	  }
	
	  _createClass(QInputForm, [{
	    key: 'handleBitsChange',
	    value: function handleBitsChange(key, event) {
	      var strValue = event.target.value;
	      var value = parseInt(strValue);
	
	      this.props.onUpdateInput(_defineProperty({}, key, value));
	    }
	  }, {
	    ...
	    value: function handleModeChange(event) {
	      ...
	      if (this.props.mode == 'float') this.props.onUpdateInput({ mode: 'hex' });
	      if (this.props.mode == 'hex') this.props.onUpdateInput({ mode: 'float' });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { type: 'button', onClick: this.handleModeChange.bind(this) },
	              this.props.mode
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'text', value: this.props.input, onChange: this.handleInputChange.bind(this) })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'two columns' },
	            ...
	            _react2.default.createElement('input', { type: 'number', min: '1', value: this.props.fractBits, onChange: this.handleBitsChange.bind(this, "fractBits") })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'two columns' },
	            ...
	            _react2.default.createElement('input', { type: 'number', min: '0', value: this.props.wholeBits, onChange: this.handleBitsChange.bind(this, "wholeBits") })
	          ),
	          _react2.default.createElement(
	            'div',
	...
	QInputForm.propTypes = {
	  mode: _react2.default.PropTypes.oneOf(['hex', 'float']),
	  input: _react2.default.PropTypes.string,
	  fractBits: _react2.default.PropTypes.number,
	  wholeBits: _react2.default.PropTypes.number
	};
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(QInputForm);
...
/***/ function(module, exports) {
	...
	var compliment = function compliment(bits) {
	  return bits.map(function (b) {
	    return 1 - b;
	  });
	};
	
	function fromIntBits(int) {
	  var fractLength = arguments.length <= 1 || arguments[1] === undefined ? 31 : arguments[1];
	  var wholeLength = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
	
	  var length = fractLength + wholeLength + 1;
	  var bits = Array(length).fill(0);
	  ...
	  if (int > 0) throw new Error("overflow bits: " + int + " did not fit in " + length + " bits");
	...
	function fromHexString(str) {
	  ...
	  var matchRes = str.match(/0x([0-9a-fA-F]+)/);
	
	  if (matchRes == null || matchRes.length != 2) throw new Error("invalid hex string: " + str);
	
	  //make a bits string from the hex string
	  var hexDigits = Array.from(matchRes[1]).map(function (char) {
	  ...
	  hexDigits.forEach(function (digit) {
	    ...
	    (_bits = bits).splice.apply(_bits, [bits.length, 0].concat(digitBits));
	  });
	  ...
	  //or fail on overflow
	  if (bits.length > length) throw new Error("overflow bits: " + str + " did not fit in " + length + " bits");
	  if (bits.length < length) bits = Array(length - bits.length).fill(0).concat(bits);
	...
	function fromFloat(float) {
	  ...
	  var wholePart = Math.floor(Math.abs(float));
	  var fractPart = Math.abs(float) - wholePart;
	
	  var wholeBits = [];
	  var wholePartRem = wholePart;
	  for (var i = 0; i < wholeLength; i++) {
	    var bit = wholePartRem % 2;
	    wholeBits.unshift(bit);
	    wholePartRem = (wholePartRem - bit) / 2;
	  }
	
	  if (wholePartRem > 0) throw new Error("overflow whole bits: " + float + " did not fit in " + wholeLength + " bits");
	
	  var fractBits = [];
	  var fractPartRem = fractPart;
	  for (var i = 0; i < fractLength; i++) {
	    var bit = fractPartRem >= 0.5 ? 1 : 0;
	    if (bit == 1) fractPartRem -= 0.5;
	    fractPartRem *= 2;
	    fractBits.push(bit);
	  }
	...
	function toFloat(q) {
	  ...
	  var isNeg = q[0] == 1;
	  var wholeBits = q.slice(1, wholeLength + 1);
	  var fractBits = q.slice(1 + wholeLength, fractLength + wholeLength + 1);
	  ...
	  var wholePart = 0;
	  for (var i = 0; i < wholeBits.length; i++) {
	    wholePart *= 2;
	    wholePart += wholeBits[i];
	  }
	
	  var fractPart = 0;
	  for (var i = fractBits.length - 1; i >= 0; i--) {
	    fractPart /= 2;
	...
	function toHexString(q) {
	  var string = "";
	  for (var i = 0; i < q.length / 4; i++) {
	    var slice = q.slice(i * 4, (i + 1) * 4);
	    var nibble = 0;
	    ...
	    if (nibble <= 9) string += nibble;else {
	      switch (nibble) {
	        case 10:
	          string += 'a';break;
	        case 11:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getCurrentQ = undefined;
	
	var _reselect = __webpack_require__(193);
	...
	var getInput = function getInput(state) {
	  return state.input;
	};
	
	//calculate the current q-value from the state
	//the result will be memoized
	var getCurrentQ = exports.getCurrentQ = (0, _reselect.createSelector)([getInput], function (input) {
	  try {
	    var q = calculateQ(input);
	    return { q: q, fractBits: input.fractBits, wholeBits: input.wholeBits };
	  } catch (error) {
	    return { error: error };
	  }
	});
	...
	function calculateQ(input) {
	  console.log(QUtil);
	  if (input.mode == 'float') {
	    var floatValue = parseFloat(input.input);
	    if (floatValue == NaN) throw new Error('invalid number: ' + input.input);
	    return QUtil.fromFloat(floatValue, input.fractBits, input.wholeBits);
	  } else if (input.mode == 'hex') {
	    if (input.input.length < 1) throw new Error('no input');
